...
const FormTweet = () => {
    const idTweet = 1622328549175709696;
    const maxResults = 10;
    const pepe = getCommentsStatistics({ idTweet, maxResults })
    console.log(pepe);
    ...
    return (
        <form className="flex items-center">
            ...
            <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-secondary rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
